      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a
              href="https://www.linkedin.com/in/sayan2713-mondal/"
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/sayan_2713?igsh=MW9oNnczNG5ncWx0aw=="
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white"
            ...
            <a
              href="https://mail.google.com/mail/?view=cm&to=sayanmondal13072002@gmail.com"
              className="hover:text-white"
              aria-label="Gmail"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            application built to simplify group expense tracking.
          </p>
        ...
        <div>
          ...
          <p className="text-sm mt-4">
            The idea of this project is not copyed by anywhere
          </p>
        </div>
        <div>
